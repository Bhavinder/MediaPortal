...
class assetupdateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $response = $client->request('PUT', 'http://202.133.73.75:8888/hwcms/v1.0/entity/image/' . $request->input('form-id'), ['headers' => ['Content-Type' => 'application/json', 'Accept' => 'application/json'], 'body' => json_encode($FormData, JSON_FORCE_OBJECT) ]);
